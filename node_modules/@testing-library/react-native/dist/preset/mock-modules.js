...
jest.doMock('react-native/Libraries/Components/ScrollView/ScrollView', function () {
  var baseComponent = (0, _mockComponent.mockComponent)('react-native/Libraries/Components/ScrollView/ScrollView', {
    instanceMethods: {
...
jest.doMock('react-native/Libraries/Components/TextInput/TextInput', function () {
  return (0, _mockComponent.mockComponent)('react-native/Libraries/Components/TextInput/TextInput', {
    instanceMethods: {
      isFocused: jest.fn(),
      clear: jest.fn(),
...
jest.doMock('react-native/Libraries/Components/Touchable/TouchableHighlight', function () {
  return (0, _mockComponent.mockComponent)('react-native/Libraries/Components/Touchable/TouchableHighlight', {
    displayName: 'TouchableHighlight'
  });
});
jest.doMock('react-native/Libraries/Components/Touchable/TouchableOpacity', function () {
  return (0, _mockComponent.mockComponent)('react-native/Libraries/Components/Touchable/TouchableOpacity', {
