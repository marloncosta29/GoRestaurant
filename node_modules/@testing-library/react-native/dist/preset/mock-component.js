...
function mockComponent(path) {
  ...
  var displayName = customDisplayName || RealComponent.displayName || RealComponent.name || (RealComponent.render ? RealComponent.render.displayName || RealComponent.render.name : 'Unknown');
