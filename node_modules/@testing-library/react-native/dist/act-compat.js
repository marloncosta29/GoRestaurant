    ...
    if (isAsyncActSupported === null) {
      return new Promise(function (resolve, reject) {
        ...
        console.error = function error() {
          ...
          if (firstArgIsString && args[0].indexOf('Warning: Do not await the result of calling TestRenderer.act') === 0) {
            isAsyncActSupported = false;
          } else if (firstArgIsString && args[0].indexOf('Warning: The callback passed to TestRenderer.act(...) function must not return anything') === 0) {} else {
